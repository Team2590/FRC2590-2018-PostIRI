...
public class LeftScaleFromRight extends AutoRoutine {
  ...
  //Code For Cross Scale From Right
    Robot.getDriveTrain().resetAllSensors();
    Robot.getElevator().moveSmooth(10, 20, 10);
    runCommand(driveForward, false);
    Timer.delay(.25);
    turnLeft = new Turn(-90, false, false);
    runCommand(turnLeft, false);
    turnLeft = new Turn(-90, false, false);
    runCommand(turnLeft, false);
    Timer.delay(.25); 
